...
import com.projektsse.backend.feature.auth.api.dto.EmailPasswordReset;
import com.projektsse.backend.feature.auth.api.dto.PasswordResetRequest;
import com.projektsse.backend.shared.exceptions.WrongTokenException;
import com.projektsse.backend.feature.auth.api.dto.PWResetTokenResponse;
import com.projektsse.backend.feature.auth.repository.PWResetRepository;
import com.projektsse.backend.feature.auth.repository.entities.PWResetToken;
import com.projektsse.backend.feature.auth.repository.entities.User;
import com.projektsse.backend.shared.service.EmailService;
...
public class PasswordResetService {
    ...
    public PasswordResetService(PWResetRepository passwordResetRepository, UserService userService, TokenService tokenService, EmailService emailService, PasswordEncoder passwordEncoder) {
